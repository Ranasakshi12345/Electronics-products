  ...
  return (
    <div className="border border-gray-200">
      ...
      <div className="px-8 py-4">
        ...
        <div className="mt-3 flex text-[#ffb21b] items-center">
          <AiFillStar />
          <AiFillStar />
          <AiFillStar />
          <AiFillStar />
        ...
        <div className="flex justify-between items-center mt-4">
            ...
            <div className="flex gap-2 items-center bg-orange-600 text-white px-4 py-2 cursor-pointer hover:bg-accent" onClick={addProductToCart}>
